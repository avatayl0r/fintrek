from PyQt5.QtWidgets import QLineEdit, QPushButton, QMessageBox, QComboBox
...
class CommonUI:
    ...
    def dropdown_button(self, items, conn) -> QComboBox:
        dropdown = QComboBox()
        dropdown.addItems(items)
        dropdown.currentIndexChanged.connect(conn)
        return dropdown
